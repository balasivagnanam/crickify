...
@Component({
  selector: 'page-sublocation-booking',
  templateUrl: 'sublocation-booking.html'
})
export class SubLocationBookingPage {
  userDetails : any;
  responseData: any;
...
subLocation:any;
  ...
  constructor(public navCtrl: NavController,public navParams: NavParams,public alertController: AlertController, public app:App, public authService:AuthService, public service:BookingService, public loadingController: LoadingController) {
  ...
  ionViewCanEnter(){
    ...
    loading.present();
    this.service.getSubLocationBooking( this.subLocation.id).then((result) => {
  ...
  cancelBooking(id,reason){
    ...
    loading.present();
    this.service.cancelOwnerBooking(id,reason).then((result) => {
